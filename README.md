...
```
knowledge-system/
├── .claude/                    # Claude Code configuration (16 commands, 11 agents)
│   ├── commands/               # Slash commands (16 total)
│   ├── agents/                 # AI tutors (11 total: language, finance, programming, etc.)
│   ├── hooks/                  # Event-driven automation (9 hooks)
...
│   └── [YYYY-MM]/              # Monthly archives (2025-10 through 2026-01)
│
...
│   ├── archive/                # Historical documentation (2025-12)
│   └── [category]/             # Other categorized docs
│
└── scripts/                    # Maintenance utilities (140+ scripts)
    ...
    ├── analytics/              # Analytics and visualizations
    ├── fact-check/             # Fact-checking utilities
    ├── github/                 # GitHub integration
    ├── maintenance/            # System maintenance
    ├── memory/                 # MCP memory utilities
...
**Last structural update**: 2026-02-03 17:30:39 +0000
**Total commits**: 842
**Total commands**: 19
**Total agents**: 13
<!-- END AUTO-GENERATED -->
...
*Root README updated by rule-inspector on 2026-02-06 to reflect current project structure (ref: commit 590881d5)*
