...
#
# This script creates/updates a GitHub repository named 'claude-brain-graph'
...
if [ "$REPO_EXISTS" = true ]; then
    ...
    if [ "$USE_TOKEN" = true ]; then
        ...
        CREATE_RESPONSE=$(curl -s -X POST \
            ...
            -d "{\"name\":\"${REPO_NAME}\",\"description\":\"Knowledge Graph Visualizations - Auto-generated by knowledge-system\",\"public\":true,\"auto_init\":false}")
        ...
        echo ""
        echo "❌ Cannot auto-create repository with SSH authentication"
        echo ""
...
This repository contains auto-generated visualizations from the knowledge-system.

**Live Pages:**
- [Analytics Dashboard](https://USERNAME.github.io/claude-brain-graph/)
- [Knowledge Graph](https://USERNAME.github.io/claude-brain-graph/graph.html)

**Generated by:** [knowledge-system](https://github.com/Yugoge/knowledge-system)
...
🤖 Auto-generated by knowledge-system
"
