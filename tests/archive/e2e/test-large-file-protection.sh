...
python3 scripts/check-file-size.py "learning-materials/language/french/First Thousand Words in French (Heather Amery) (Z-Library).pdf"
echo ""

# Test 2: JSON Output
echo "Test 2: JSON Output"
echo "-------------------"
python3 scripts/check-file-size.py "learning-materials/language/french/First Thousand Words in French (Heather Amery) (Z-Library).pdf" --json | python3 -m json.tool
echo ""

# Test 3: TOC Extraction
echo "Test 3: TOC Extraction (CFA Book)"
echo "--------------------------------"
python3 scripts/extract-pdf-chunk.py "learning-materials/finance/cfa/notes/CFA 2025 Level I - SchweserNotesBook 1.pdf" --mode toc | head -30
echo ""

# Test 4: Page Extraction
echo "Test 4: Page Extraction (First 2 pages)"
echo "---------------------------------------"
python3 scripts/extract-pdf-chunk.py "learning-materials/finance/cfa/notes/CFA 2025 Level I - SchweserNotesBook 1.pdf" --mode pages --pages 1-2 | head -40
echo ""
...
echo '{"tool_input":{"file_path":"learning-materials/language/french/First Thousand Words in French (Heather Amery) (Z-Library).pdf"}}' | python3 scripts/hook-check-read-size.py
HOOK_EXIT=$?
